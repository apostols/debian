...
%files
%defattr (-,root,root,-)
%{_datadir}/%{name}-%{version}/examples/motion-dist.conf
%{_datadir}/%{name}-%{version}/examples/motion.init-Debian
%{_datadir}/%{name}-%{version}/examples/motion.init-FreeBSD.sh
%{_datadir}/%{name}-%{version}/examples/motion.init-RH
%{_datadir}/%{name}-%{version}/examples/thread1.conf
%{_datadir}/%{name}-%{version}/examples/thread2.conf
%{_datadir}/%{name}-%{version}/examples/thread3.conf
%{_datadir}/%{name}-%{version}/examples/thread4.conf
